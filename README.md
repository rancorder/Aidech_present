...
Aidech Management の営業用Webスライドです。リポジトリ内の `images/` に置いたスライド画像を読み込み、台本を見ながら操作できます。
...
`IMAGE_MANIFEST.md` の対応表どおりに、`images/` フォルダへ画像を配置してください。
...
Google Drive画像の直リンク参照は使っていません。画像は必ず `images/` 配下に同梱してください。
